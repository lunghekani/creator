...
$result = $conn-> query("SELECT Structure_HTML FROM $dbname.topic_content where Topic_ID= $topicCookie;") or die($conn->connect_error);

while($row = $result-> fetch_assoc()):
       $contenttoedit = $row['Structure_HTML'];
endwhile;
...
<html lang="en">
    ...
    <body>
       ...
       // setcookie("userID", $_GET['userID'], time()+(60*60), "/" );
        ...
        ?>
        <form method="get" action="php/update_form_data.php" id="myForm">
